          ...
          {cases.map(caseItem => <div key={caseItem.id} className="bg-black rounded-lg overflow-hidden shadow-md card-hover reveal">
              <div className="grid grid-cols-2 gap-4">
                <div className="h-64 overflow-hidden relative">
                  ...
                  <img src={caseItem.before} alt={`${caseItem.title} - Antes`} className={`w-full h-full object-cover transition-transform duration-300 hover:scale-105 ${caseItem.id === 1 ? 'object-[center_35%]' : 'object-center'}`} />
                </div>
                <div className="h-64 overflow-hidden relative">
