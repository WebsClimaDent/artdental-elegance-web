...
const cases = [
  {
    ...
    after: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=1887&auto=format&fit=crop",
    link: "/casos",
  },
  {
    id: 2,
    ...
    after: "https://images.unsplash.com/photo-1601758228041-f3b2795255f1?q=80&w=1770&auto=format&fit=crop",
    link: "/casos",
  },
];
...
const CasesPreview = () => {
  return (
    <section className="section-padding bg-white" id="casos">
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                <div className="h-64 overflow-hidden relative">
                  <span className="absolute top-2 left-2 bg-dental-dark text-white text-xs px-2 py-1 rounded">
                    Antes
                  </span>
                  <img
                    src={caseItem.before}
                ...
                <div className="h-64 overflow-hidden relative">
                  <span className="absolute top-2 right-2 bg-dental-light text-dental-dark text-xs px-2 py-1 rounded">
                    Después
                  </span>
                  <img
                    src={caseItem.after}
              ...
              <div className="p-6">
                ...
                <p className="text-dental-DEFAULT mb-4">{caseItem.description}</p>
                <Link
                  to={caseItem.link}
