        ...
        <div className="mt-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">
              Las coronas sobre implantes de zirconio monolítico o zirconio multicapa representan una opción avanzada en odontología restauradora. Están fabricadas completamente en zirconio, un material cerámico de alta resistencia, durabilidad y biocompatibilidad, que además ofrece una estética natural y predecible. El zirconio multicapa incorpora distintas capas con propiedades ópticas variables, lo que permite simular de forma más realista la anatomía del diente natural, incluyendo gradaciones de color y niveles de translucidez que imitan la transición entre dentina y esmalte. Cuando se utiliza la técnica de zirconio multicapa monolítico, la corona se fabrica a partir de un solo bloque, sin necesidad de aplicar capas adicionales de cerámica. Esto mejora considerablemente su resistencia y reduce el riesgo de complicaciones como astillados, fracturas o descementaciones del recubrimiento cerámico.
            </p>
          </div>
