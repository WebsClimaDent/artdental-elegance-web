    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-20">
        ...
        <div className="container-custom py-6">
          <Link 
            to="/" 
            className="inline-flex items-center text-dental-primary hover:text-dental-dark transition-colors group"
          >
        ...
        <div className="container-custom py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-16">
              <div className="bg-dental-light/30 rounded-lg p-8 mb-12">
                <h2 className="text-3xl font-playfair font-bold text-dental-dark mb-6 border-b-2 border-dental-primary pb-4">
                  I. POLÍTICA DE PRIVACIDAD Y PROTECCIÓN DE DATOS
                </h2>
                
                <p className="text-gray-700 mb-8 text-lg leading-relaxed">
                  Respetando lo establecido en la legislación vigente, <strong className="text-dental-dark">ARTDENTAL – Laboratorio Estética Dental</strong> (en adelante, también el Sitio Web) se compromete a adoptar las medidas técnicas y organizativas necesarias, según el nivel de seguridad adecuado al riesgo de los datos recogidos.
                </p>
              </div>

              <div className="space-y-12">
                <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
                  <h3 className="text-2xl font-playfair font-bold text-dental-dark mb-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-dental-light/20 p-4 rounded-lg">
                      <p className="font-semibold text-dental-dark">• Reglamento (UE) 2016/679 (RGPD)</p>
                    </div>
                    <div className="bg-dental-light/20 p-4 rounded-lg">
                      <p className="font-semibold text-dental-dark">• Ley Orgánica 3/2018 (LOPD-GDD)</p>
                    </div>
                    <div className="bg-dental-light/20 p-4 rounded-lg">
                      <p className="font-semibold text-dental-dark">• Real Decreto 1720/2007 (RDLOPD)</p>
                    </div>
                    <div className="bg-dental-light/20 p-4 rounded-lg">
                      <p className="font-semibold text-dental-dark">• Ley 34/2002 (LSSI-CE)</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
                  ...
                  <div className="bg-gradient-to-r from-dental-light/40 to-dental-primary/20 p-6 rounded-lg border-l-4 border-dental-primary">
                    <p className="font-bold text-dental-dark text-lg mb-2">ARTDENTAL – Laboratorio Estética Dental</p>
                    <p className="text-gray-700 mb-2">📍 Av. de Joan XXIII, 48, bajo, Benicalap, 46025 Valencia</p>
                    <p className="text-gray-700">✉️ info@artdentalvlc.com</p>
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      ...
                      <div key={index} className="flex items-center p-3 bg-dental-light/20 rounded-lg">
                        <span className="text-dental-primary mr-3">✓</span>
                        <span className="text-gray-700 font-medium">{principio}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
                    <h3 className="text-xl font-playfair font-bold text-dental-dark mb-4">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      ...
                      <div key={index} className="flex items-start p-4 bg-dental-light/20 rounded-lg">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-dental-light/30 p-4 rounded-lg border-l-4 border-dental-primary">
                      <p className="text-gray-700 leading-relaxed">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    {[
                      ...
                      <div key={index} className="bg-dental-light/20 p-3 rounded-lg text-center">
                        <span className="text-dental-dark font-medium">{derecho}</span>
                      </div>
                    ))}
                  </div>
                  
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h4 className="font-bold text-dental-dark mb-4">Para ejercer estos derechos, debe enviar solicitud con:</h4>
                    ...
                    <div className="bg-white p-4 rounded-lg border border-dental-primary/30">
                      <p className="font-semibold text-dental-dark mb-2">Datos de contacto:</p>
                      <p className="text-gray-700">📍 Av. de Joan XXIII, 48, bajo, Benicalap, 46025 Valencia</p>
                      <p className="text-gray-700">✉️ info@artdentalvlc.com</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
                    ...
                    <a 
                      ...
                      className="inline-flex items-center text-dental-primary hover:text-dental-dark underline font-medium"
                    >
                      🔗 https://www.aepd.es
                    </a>
                  </div>
            ...
            <section className="bg-gradient-to-r from-dental-dark to-dental-primary rounded-lg p-8 text-white">
