...
const serviceCategories = [{
  ...
  services: [{
    ...
    benefits: ["Transformación estética inmediata.", "Conservación máxima del diente natural.", "Resistencia a las manchas.", "Durabilidad excepcional.", "Personalización total."],
    materials: ["Porcelana feldespática de alta calidad.", "Cerámicas estratificadas artesanales.", "Sistemas de adhesión avanzados."],
    testimonial: {
    ...
    benefits: ["Estética natural: color y translucidez similares al diente real.", "Alta precisión: ajuste exacto gracias a la tecnología CAD/CAM.", "Gran resistencia: soporta la masticación sin fracturas.", "Durabilidad: mantiene forma y función por muchos años.", "Biocompatibilidad: material hipoalergénico y seguro para los tejidos."],
    materials: ["Disilicato de litio monolítico.", "Cerámica reforzada con polímeros.", "Composite nanohíbrido de alta densidad."],
    testimonial: {
    ...
    additionalImages: ["/lovable-uploads/33f19cab-a7ba-41be-8791-7779d844bc96.png", "/lovable-uploads/26355edf-566d-4fa7-8b05-f9367fc46a47.png"],
    galleryImages: ["/lovable-uploads/c261d174-eaa4-4b00-81ee-221648122b05.png", "/lovable-uploads/15f8619d-4aab-4958-a7a6-e842f5e60dae.png", "/lovable-uploads/a3a60322-55e9-40bf-9345-7efa3e1109c2.png"]
  }]
}, {
  id: 3,
  ...
  services: [{
    ...
    detailedDescription: "Las prótesis sobre implantes representan el estándar más alto en la reposición de dientes unitarios. Diseñadas con precisión digital y fabricadas con materiales de última generación, estas restauraciones se integran perfectamente con la dentición natural, tanto en forma como en función. En ArtDental, prestamos especial atención al perfil de emergencia y la interfaz con el tejido gingival para lograr resultados que desafían la detección.",
    benefits: ["Reemplazo dental sin afectar dientes adyacentes.", "Preservación del hueso alveolar.", "Estética mimetizada al diente natural.", "Funcionalidad completa y duradera.", "Mantenimiento simple como un diente natural."],
    materials: ["Zirconio monolítico.", "Zirconio multicapa con diferentes capas de translucidez.", "Material base para ambas opciones es biocompatible, resistente y duradero."],
    additionalImages: ["/lovable-uploads/023de864-ad84-4b89-8f4e-942d8f3f4367.png", "/lovable-uploads/26355edf-566d-4fa7-8b05-f9367fc46a47.png"],
    galleryImages: ["/lovable-uploads/bca74c94-aa67-4872-8420-d0bfdb27b2f3.png", "/lovable-uploads/498b69ea-73bb-496b-8512-224a0e11da68.png", "/lovable-uploads/b9a35424-8b41-4dde-ba7f-348c2ebe7044.png", "/lovable-uploads/7eb7f152-098a-4b29-987c-f4862156b8b3.png"]
  }, {
    id: 7,
    ...
    image: "/lovable-uploads/8b3e3ddd-a64a-47fe-9d7c-fab39248d033.png",
    ...
    benefits: ["Restauración completa de función masticatoria.", "Estabilidad oclusal perfecta.", "Rejuvenecimiento facial integral.", "Prevención de reabsorción ósea.", "Solución definitiva y duradera."],
    materials: ["Barras de refuerzo en titanio.", "Zirconio multicapas estetificado.", "Sistemas de conexión de alta precisión."],
    testimonial: {
    ...
    additionalImages: ["/lovable-uploads/24dcc657-382e-4b26-98a0-40afbb400a15.png", "/lovable-uploads/26355edf-566d-4fa7-8b05-f9367fc46a47.png"]
  }]
}];
const Servicios = () => {
  ...
  return <>
      ...
      <main className="bg-dental-dark min-h-screen pt-24">
        ...
        {serviceCategories.map(category => <section key={category.id} className="py-8 md:py-10" id={`category-${category.id}`}>
            <div className="container-custom">
              <h2 className="text-3xl font-playfair font-semibold mb-6 text-white text-center">{category.title}</h2>
              
              <div className="space-y-8">
                {category.services.map((service, index) => <div key={service.id} id={getServiceId(service.title)} className={`reveal flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-8 items-center`}>
                    <div className="lg:w-1/2">
                      <div className={`rounded-lg overflow-hidden shadow-2xl ${service.id === 6 ? 'h-[320px]' : service.id === 7 ? 'h-[320px]' : service.id === 3 ? 'h-[320px]' : 'h-96'}`}>
                        <TiltedCard imageSrc={service.image} altText={service.title} captionText="" containerWidth="100%" containerHeight="100%" imageWidth="100%" imageHeight="100%" scaleOnHover={1.08} rotateAmplitude={12} showTooltip={false} objectFit="cover" className={service.id === 6 ? 'object-cover object-center' : service.id === 7 ? 'object-cover object-[50%_35%]' : service.id === 3 ? 'object-cover object-center' : 'object-cover'} />
                      </div>
                    </div>
                    <div className="lg:w-1/2">
                      <h3 className="text-2xl font-playfair font-semibold mb-4 text-white">{service.title}</h3>
                      <p className="text-gray-300 mb-6">
                        {service.title === "Carillas mínimamente invasivas" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-dental-dark rounded-lg overflow-hidden shadow-xl card-hover reveal">
                <div className="h-72 overflow-hidden">
                  <TiltedCard imageSrc="/lovable-uploads/38346735-e5b0-47d9-873d-070f34663819.png" altText="Carillas mínimamente invasivas" captionText="" containerWidth="100%" containerHeight="100%" imageWidth="100%" imageHeight="100%" scaleOnHover={1.1} rotateAmplitude={10} showTooltip={false} objectFit="cover" className="object-cover object-center" />
                </div>
                <div className="p-6">
              ...
              <div className="bg-dental-dark rounded-lg overflow-hidden shadow-xl card-hover reveal">
                <div className="h-72 overflow-hidden">
                  <TiltedCard imageSrc="/lovable-uploads/b66d5758-5a24-479d-8320-b40d580f5e12.png" altText="Prótesis sobre Implantes" captionText="" containerWidth="100%" containerHeight="100%" imageWidth="100%" imageHeight="100%" scaleOnHover={1.1} rotateAmplitude={10} showTooltip={false} objectFit="cover" />
                </div>
                <div className="p-6">
                  <h3 className="text-xl font-playfair font-semibold mb-2 text-white">Prótesis sobre Implantes </h3>
                  <p className="text-gray-300 mb-4">Material de última generación que combina resistencia superior con excelente estética. Perfecto para rehabilitaciones completas o parciales.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-8 md:py-10 bg-black">
          <div className="container-custom text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Contáctanos para evaluar casos específicos y desarrollar juntos 
        ...
        {selectedService && <ServiceDialog isOpen={dialogOpen} onClose={() => setDialogOpen(false)} service={selectedService} />}
      </main>
      <Footer />
    </>;
};
