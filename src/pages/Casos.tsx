...
const cases = [
  ...
  },
  {
    ...
    challenge: "Caso realizado con enfoque en prótesis fija, mediante un diseño restaurador precisión, funcionalidad y estética natural.",
    solution: "Rehabilitación completa con prótesis fija en cerámica, diseñada digitalmente bajo el concepto de restauraciones.",
    materials: "Materiales cerámicos biocompatibles, de alta resistencia y estética,Planificación digital de sonrisa y oclusión con precisión restauradora.",
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-8">
                      ...
                      <div className="relative rounded-lg overflow-hidden">
                        ...
                        <img 
                          ...
                          className={`w-full h-72 object-cover ${caseItem.id === 1 ? 'object-[center_20%]' : caseItem.id === 3 ? 'object-[center_80%]' : 'object-center'}`}
                        />
                      </div>
                    </div>
                  )}
