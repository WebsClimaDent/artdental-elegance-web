...
const cases = [
  ...
  },
  {
    ...
    challenge: "Múltiples problemas estéticos y funcionales y necesidad de armonización completa de la sonrisa.",
    solution: "Rehabilitación fija estética en dientes anteriores con coronas de ceramica.",
    materials: "Coronas de ceramica, planificación digital del diseño de sonrisa.",
